...
const SignIn = () => {
  return (
    <div className="flex flex-col h-full w-[480px] max-w-full min-h-[500px] relative bg-white text-custom-gray my-0 mx-auto">
      <div className="p-2"> 
      ...
      <div className="mb-2 flex items-center justify-center h-16">
        <Image src="/myjumia-top-logo.png" width="64" height="64" />
      </div>
      ...
      <div className="mt-80 text-sm  bottom-0">
        <div
        ...
        <svg role="img" viewBox="0 0 172 30" width="97" height="16" className="mx-auto">
            <path
              fill="#282828"
