      ...
      {isDropdownOpen && (
        <div className="absolute rounded shadow-[0_0_10px_0_rgba(0,0,0,0.15)] top-full bg-white font-normal w-full min-w-[206px]">
          <div className="p-4 flex  items-center justify-center border-b ">
            <div className="py-3 px-4 w-full font-medium cursor-pointer whitespace-nowrap text-white leading-4 hover:bg-custom-hover-orange shadow-[0_4px_8px_0_rgba(0,0,0,0.2)] felx items-center justify text-center uppercase bg-custom-orange rounded">
              Se connecter
            </div>
          </div>
