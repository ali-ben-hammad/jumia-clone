    ...
    <>
      ...
      <form onSubmit={handleSubmit} action="" className="w-full">
        <div className="text-center w-full">
          <h2 className="font-bold text-black text-xl ">Créez votre compte</h2>
          <p className="font-normal text-base mt-2 mb-4 text-custom-gray text-center">
            Commençons par créer votre compte. Pour assurer la sécurité de votre
            compte, nous avons besoin d'un mot de passe fort!
          </p>
        </div>
        <div className="pt-4">
          ...
          <div className="relative mt-8 flex text-custom-gray">
            <input
              ...
              className="w-full border border-gray-300 rounded px-3 py-2 outline-none peer focus:border-custom-orange focus:border-2 focus:ring-custom-orange focus:ring-opacity-50 transition-all duration-200 ease-in-out placeholder-transparent"
          ...
          <div className="relative mt-8 flex group text-custom-gray">
            <input
              id="confirmPassword"
